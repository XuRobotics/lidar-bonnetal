...
python3.7 ./train.py -d /home/gnardari/Documents/data/simulated_data -ac ./config/arch/quad/quad_sim_erfnet.yaml -dc ./config/labels/quad_binary.yaml -l ../../../models/quad_sim_erfnet/
